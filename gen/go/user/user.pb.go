...
const file_user_user_proto_rawDesc = "" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB\x0fZ\r./user;userpbb\x06proto3"
...
var file_user_user_proto_depIdxs = []int32{
	...
	2, // 1: user.User.DeleteUser:input_type -> user.DeleteUserRequest
	1, // 2: user.User.CreateUser:output_type -> user.CreateUserResponse
	3, // 3: user.User.DeleteUser:output_type -> user.DeleteUserResponse
